...
func (_mock *MockDoer) Do(ctx context.Context, req *Request) (*Response, error) {
...
func (_c *MockDoer_Do_Call) Run(run func(ctx context.Context, req *Request)) *MockDoer_Do_Call {
...
func (_c *MockDoer_Do_Call) Return(response *Response, err error) *MockDoer_Do_Call {
	_c.Call.Return(response, err)
	return _c
}

func (_c *MockDoer_Do_Call) RunAndReturn(run func(ctx context.Context, req *Request) (*Response, error)) *MockDoer_Do_Call {
	_c.Call.Return(run)
	return _c
}
